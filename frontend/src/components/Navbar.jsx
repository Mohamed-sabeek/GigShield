                    ...
                    {!token ? (
                        <>
                            ...
                            {location.pathname !== '/signup' && (
                                <Link to="/signup" className="px-5 py-2.5 bg-slate-900 text-white text-sm font-bold rounded-full hover:bg-slate-800 transition active:scale-95 shadow-xl shadow-slate-900/10">Get Protected</Link>
                            )}
                        </>
                    ) : (
